                ...
                todoList.innerHTML += `
                    <li class="list-group-item d-flex justify-content-between align-items-center" key=${todo._id.$oid}>
                        <div>
                            ...
                            <h5 ${todo.completed ? 'style="text-decoration:line-through;"' : ""}>${todo.task}</h5>
                        ...
                        <div>
                           Status : ${todo.completed ? `<span class="text-sm btn-success p-1 rounded-lg">Completed</span>` : `<span class="text-sm rounded-lg p-1 btn-warning">In-Progress</span>`}
                        </div>

                        <div>
                            ${todo.completed ? `` : `<button class="btn btn-success btn-sm" onclick="toggleComplete('${todo._id.$oid}')">Mark as Done</button>
